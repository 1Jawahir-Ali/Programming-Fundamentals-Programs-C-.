...
int reservedCount = 0;
MenuItem breakfastMenu[menuSize] = { {"Paratha & Tea", 250}, {"Halwa Puri", 300}, {"Omelette & Toast", 200},{"Balti Tea", 300},
                                     {"Aloo Paratha", 280}, {"Channa Bhatura", 320}, {"Paye & Naan", 500} };
MenuItem lunchMenu[menuSize] = { {"Chicken Biryani", 400}, {"Beef Korma", 500}, {"Daal Chawal", 250},{"Parapo", 700},
                                 {"Karahi", 800}, {"Palak Paneer", 450}, {"Chicken Handi", 750} };
MenuItem dinnerMenu[menuSize] = { {"Mutton Karahi", 1200}, {"BBQ Platter", 1000}, {"Fish Fry", 900},{"Chul Chul", 800},{"Maar Zaan", 400},
